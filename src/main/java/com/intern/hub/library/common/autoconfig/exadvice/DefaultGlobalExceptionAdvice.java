...
/**
 * Global exception handler that provides centralized exception handling for REST controllers.
 * <p>
 * This advice catches various exception types and transforms them into standardized
...
public class DefaultGlobalExceptionAdvice {
    ...
    return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(
        new ResponseApi<>(
            new ResponseStatus(ExceptionConstant.INTERNAL_SERVER_ERROR_DEFAULT_CODE,
                exception.getMessage() != null ? exception.getMessage() : ExceptionConstant.UNKNOWN_ERROR),
            null,
  ...
  public ResponseEntity<ResponseApi<?>> handleNotFoundException(NotFoundException exception) {
    return ResponseEntity.status(HttpStatus.NOT_FOUND).body(
        new ResponseApi<>(
            new ResponseStatus(
                exception.getCode() != null ? exception.getCode() : ExceptionConstant.NOT_FOUND_DEFAULT_CODE,
                exception.getMessage() != null ? exception.getMessage() : ExceptionConstant.RESOURCE_NOT_FOUND
            ),
            null,
            ResponseMetadata.fromRequestId()
        )
  ...
  public ResponseEntity<ResponseApi<?>> handleBadRequestException(BadRequestException exception) {
    return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(
        new ResponseApi<>(
            new ResponseStatus(
                exception.getCode() != null ? exception.getCode() : ExceptionConstant.BAD_REQUEST_DEFAULT_CODE,
                exception.getMessage() != null ? exception.getMessage() : ExceptionConstant.BAD_REQUEST
            ),
            null,
            ResponseMetadata.fromRequestId()
        )
  ...
  public ResponseEntity<ResponseApi<?>> handleConflictDataException(ConflictDataException exception) {
    return ResponseEntity.status(HttpStatus.CONFLICT).body(
        new ResponseApi<>(
            new ResponseStatus(
                exception.getCode() != null ? exception.getCode() : ExceptionConstant.CONFLICT_DATA_DEFAULT_CODE,
                exception.getMessage() != null ? exception.getMessage() : ExceptionConstant.CONFLICT_DATA
            ),
            null,
            ResponseMetadata.fromRequestId()
        )
  ...
  public ResponseEntity<ResponseApi<?>> handleForbiddenException(ForbiddenException exception) {
    return ResponseEntity.status(HttpStatus.FORBIDDEN).body(
        new ResponseApi<>(
            new ResponseStatus(
                exception.getCode() != null ? exception.getCode() : ExceptionConstant.FORBIDDEN_DEFAULT_CODE,
  ...
  public ResponseEntity<ResponseApi<?>> handleUnauthorizeException(UnauthorizeException exception) {
    return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(
        new ResponseApi<>(
            new ResponseStatus(
                exception.getCode() != null ? exception.getCode() : ExceptionConstant.UNAUTHORIZED_DEFAULT_CODE,
                exception.getMessage() != null ? exception.getMessage() : ExceptionConstant.UNAUTHORIZED
            ),
            null,
            ResponseMetadata.fromRequestId()
        )
  ...
  public ResponseEntity<ResponseApi<?>> handleTooManyRequestException(TooManyRequestException exception) {
    return ResponseEntity.status(HttpStatus.TOO_MANY_REQUESTS).body(
        new ResponseApi<>(
            new ResponseStatus(
                exception.getCode() != null ? exception.getCode() : ExceptionConstant.TOO_MANY_REQUESTS_DEFAULT_CODE,
                exception.getMessage() != null ? exception.getMessage() : ExceptionConstant.TOO_MANY_REQUESTS
            ),
            null,
            ResponseMetadata.fromRequestId()
        )
  ...
  public ResponseEntity<ResponseApi<?>> handleInternalErrorException(InternalErrorException exception) {
    return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(
        new ResponseApi<>(
            new ResponseStatus(
                exception.getCode() != null ? exception.getCode() : ExceptionConstant.INTERNAL_SERVER_ERROR_DEFAULT_CODE,
                exception.getMessage() != null ? exception.getMessage() : ExceptionConstant.UNKNOWN_ERROR
            ),
            null,
            ResponseMetadata.fromRequestId()
  ...
  /**
   * Handles MethodArgumentTypeMismatchException when a request parameter cannot be converted to the expected type.
   *
   * @param exception the MethodArgumentTypeMismatchException that was thrown
   * @return a ResponseEntity containing the error response with HTTP 400 status
   */
  @ExceptionHandler(MethodArgumentTypeMismatchException.class)
  public ResponseEntity<ResponseApi<?>> handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException exception) {
  ...
  /**
   * Handles MethodArgumentNotValidException for validation errors on request body fields.
   * <p>
   * Returns a list of {@link FieldError} objects containing details about each invalid field.
   * </p>
   *
   * @param exception the MethodArgumentNotValidException that was thrown
   * @return a ResponseEntity containing the error response with field errors and HTTP 400 status
   */
  @ExceptionHandler(MethodArgumentNotValidException.class)
  public ResponseEntity<ResponseApi<List<FieldError>>> handleMethodArgumentNotValidException(MethodArgumentNotValidException exception) {
