...
/**
 * Thread-safe holder for the current {@link AuthContext} using Java's {@link ScopedValue}.
 * <p>
 * This class provides access to the authentication context that has been bound
 * to the current scope. It uses {@link ScopedValue} (introduced in Java 21) which
 * provides a more efficient alternative to {@link ThreadLocal} for virtual threads.
 * </p>
 *
 * <p><b>Usage:</b></p>
 * <pre>{@code
...
public final class AuthContextHolder {
   ...
   * </p>
   */
  public final static ScopedValue<AuthContext> AUTH_CONTEXT = ScopedValue.newInstance();
   ...
   * @throws IllegalStateException if no AuthContext has been bound to the current scope
   */
